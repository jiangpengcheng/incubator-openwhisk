...
class MongoDBArtifactStoreTests extends FlatSpec with ArtifactStoreBehavior {
  override def storeType = "MongoDB"

  override val authStore = {
    implicit val docReader: DocumentReader = WhiskDocumentReader
    MongoDbStoreProvider.makeStore[WhiskAuth]()
  }

  override val entityStore =
    MongoDbStoreProvider.makeStore[WhiskEntity]()(
